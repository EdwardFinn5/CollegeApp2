...
namespace API.Migrations
{
    ...
    [Migration("20210807233333_MessageEntityAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.ColUserLike", b =>
                {
                    b.Property<int>("SourceColUserId")
                        .HasColumnType("int");

                    b.Property<int>("LikedColUserId")
                        .HasColumnType("int");

                    b.HasKey("SourceColUserId", "LikedColUserId");

                    b.HasIndex("LikedColUserId");
            ...
            modelBuilder.Entity("API.Entities.Message", b =>
                {
                    ...
                    b.Property<string>("RecipientColUserType")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("RecipientColUsername")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("RecipientCollegeName")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("RecipientHsName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("RecipientId")
                        .HasColumnType("int");

                    b.Property<string>("SenderColUserType")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SenderColUsername")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SenderCollegeName")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("SenderHsName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("API.Entities.ColUserLike", b =>
                {
                    b.HasOne("API.Entities.ColUser", "LikedColUser")
                        .WithMany("LikedByColUsers")
                        .HasForeignKey("LikedColUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("API.Entities.ColUser", "SourceColUser")
                        .WithMany("LikedColUsers")
                        .HasForeignKey("SourceColUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("LikedColUser");

                    b.Navigation("SourceColUser");
                });
            ...
            modelBuilder.Entity("API.Entities.Message", b =>
                {
                    b.HasOne("API.Entities.ColUser", "Recipient")
                        .WithMany("MessagesReceived")
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("API.Entities.ColUser", "Sender")
            ...
            modelBuilder.Entity("API.Entities.ColUser", b =>
                {
                    ...
                    b.Navigation("LikedByColUsers");

                    b.Navigation("LikedColUsers");
