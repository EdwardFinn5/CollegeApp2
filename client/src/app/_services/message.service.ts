...
export class MessageService {
  ...
  getMessageThread(colUsername: string) {
    return this.http.get<Message[]>(
      this.baseUrl + 'messages/thread/' + colUsername
    );
  }

  sendMessage(colUsername: string, content: string) {
    return this.http.post<Message>(this.baseUrl + 'messages', {
      recipientColUsername: colUsername,
      content,
    });
  }
